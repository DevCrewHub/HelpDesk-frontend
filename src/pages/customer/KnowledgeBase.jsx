  ...
  return (
    ...
    <div className="flex-grow px-6 py-2">
        <div className="-mx-6 bg-gradient-to-b from-white to-gray-50 border-b border-gray-300 mt-2 pb-2 mb-6">
          <h1 className="text-2xl font-semibold tracking-tight pb-2 px-6">Knowledge Base</h1>
        </div>
        ...
        <div className="bg-white mb-8 border border-gray-200 border-l-4 border-l-orange-400 rounded-lg shadow-md">
          <div className="p-6">
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-3 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none"
          />
        </div>
...
const CategoryButton = ({ label, selected, onClick }) => (
  <button
    ...
    className={`px-4 py-2 text-sm rounded-full cursor-pointer transition-colors ${
      selected ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-indigo-100'
    }`}
  >
    {label}
  </button>
      ...
      <div className="p-6 cursor-pointer" onClick={onToggle}>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <h3 className="text-lg font-semibold text-indigo-600 group-hover:text-indigo-800 transition-colors mb-2">
              {faq.question}
            </h3>
